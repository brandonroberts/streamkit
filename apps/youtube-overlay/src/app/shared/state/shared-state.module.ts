...
@NgModule({
  imports: [
    ...
    EffectsModule.forFeature([AlertsEffects, WebSocketEffects, MessagesEffects, YouTubeEffects]),
    StoreModule.forFeature(SubscriptionsFeature.subscriptionsFeatureKey, SubscriptionsFeature.reducer)
  ]
})
